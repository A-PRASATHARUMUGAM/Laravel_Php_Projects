...
document.addEventListener("DOMContentLoaded", function () {
  feather.replace();
  var r = document.querySelector(".loader-bg"),
    e =
      ...
      (!document.querySelector("body").hasAttribute("data-pc-layout") ||
        ...
        add_scroller(),
      document.querySelector(".hamburger:not(.is-active)")),
    e =
      (e &&
    ...
    e =
      ...
      document.querySelector("#mobile-collapse")),
    e =
      (e &&
        e.addEventListener("click", function () {
          document.querySelector(".pc-sidebar") &&
      ...
      document.querySelector(".pc-horizontal #mobile-collapse")),
    e =
      (e &&
        e.addEventListener("click", function () {
          document
      ...
      document.querySelector(".pc-horizontal .topbar .pc-navbar>li>a")),
    e =
      (e &&
        e.addEventListener("click", function (e) {
          var t = e.target;
          setTimeout(function () {
            t.parentNodes.children[1].removeAttribute("style");
          }, 1e3);
        }),
...
function layout_sidebar_change(e) {
  "dark" == e
    ? (document
        .getElementsByTagName("body")[0]
        .setAttribute("data-pc-sidebar-theme", "dark"),
      document.querySelector(".theme-sidebar-color .btn.active") &&
        (document
...
function layout_header_change(e) {
  "dark" == e
    ? (document
        .getElementsByTagName("body")[0]
        .setAttribute("data-pc-header-theme", "dark"),
      document.querySelector(".theme-header-color .btn.active") &&
        (document
  ...
  t && t.classList.remove("active"),
    "dark" == e
      ? ((dark_flag = !0),
        ...
        document.querySelector(".auth-form img.img-logo") &&
          document
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var r = document.querySelector("#layoutreset");
  r &&
