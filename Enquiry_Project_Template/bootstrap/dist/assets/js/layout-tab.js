(() => {
  ...
  for (
    var r,
      ...
      e =
        (document.querySelector(".tab-container > .tab-sidemenu") &&
          new SimpleBar(
            document.querySelector(".tab-container > .tab-sidemenu")
          ),
        ...
        document.querySelectorAll(".pc-navbar li .pc-submenu")),
      t = 0;
    t < e.length;
    t++
  )
        ...
        if (d) {
          ...
          d.insertAdjacentHTML(
            ...
            '<li class="nav-item" data-bs-toggle="tooltip" title="' +
              ...
              c +
              '" role="tab" data-bs-toggle="tab" aria-controls="home-tab-pane"            "data-bs-placement="right">' +
              a +
              "</a></li>"
          );
        }
  ...
  for (
    var a = document.querySelectorAll(".pc-sidebar .pc-navbar a"), n = 0;
    n < a.length;
    n++
  ) {
    ...
    if (a[n].href == s && "" != a[n].getAttribute("href")) {
      a[n].parentNode.classList.add("active"),
        ...
        (a[n].parentNode.parentNode.parentNode.parentNode.style.display =
          "block");
      for (var p, u = !0, m = a[n]; u; )
        (m = m.parentNode).classList.contains("tab-pane") &&
          ((p = m.getAttribute("id")),
          (p = document.querySelector(
            '.tab-sidemenu a[data-bs-target="#' + p + '"]'
          )),
