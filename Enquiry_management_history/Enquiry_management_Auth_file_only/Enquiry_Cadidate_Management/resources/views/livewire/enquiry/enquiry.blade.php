    ...
    <!-- [ Main Content ] start -->
            ...
            <div class="card feed-card">
              ...
              <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-primary py-1" data-bs-toggle="modal" data-bs-target="#addEnquiryModal">
                  Add Enquiry
                </button>
              </div>
              <!-- Enquiry Header end -->
                          ...
                          <div class="table-responsive feed-scroll" style="max-height: 500px; overflow-y: auto; position: relative;">
                            <table class="table table-bordered table-hover mb-0 fixed-header">
                              ...
                              <tbody>
                                <tr>
                                  <td>1</td><td>Arun Kumar</td><td>9876543210</td><td>Enquiry</td>
                                  <td>

                                    <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#viewEnquiryModal">View</button>

                                      <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editEnquiry1">Edit</button>
                                    <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal">Delete</button>
                                  </td>
                                </tr>
                                <tr>
                                  <td>2</td><td>Meena R</td><td>9123456789</td><td>New</td>
                                  <td>
                                ...
                                <!-- Data 3 -->
                                <tr>
                                  <td>3</td><td>Prakash S</td><td>9001122334</td><td>Contacted</td>
                                  <td>
                                    <button class="btn btn-sm btn-info">View</button>
                                    <button class="btn btn-sm btn-warning">Edit</button>
                                    <button class="btn btn-sm btn-danger">Delete</button>
                                ...
                                <!-- Data 4 -->
                                <tr>
                                  <td>4</td><td>Ravi Kumar</td><td>9887766554</td><td>Interested</td>
                                  <td>
                                    <button class="btn btn-sm btn-info">View</button>
                                    <button class="btn btn-sm btn-warning">Edit</button>
                                    <button class="btn btn-sm btn-danger">Delete</button>
                                ...
                                <!-- Data 5 -->
                                <tr>
                                  <td>5</td><td>Sneha P</td><td>9090909090</td><td>Enquiry</td>
                                  <td>
                                    <button class="btn btn-sm btn-info">View</button>
                                    <button class="btn btn-sm btn-warning">Edit</button>
                                    <button class="btn btn-sm btn-danger">Delete</button>
                                ...
                                <!-- Data 6 -->
                                <tr>
                                  <td>6</td><td>Karthik S</td><td>9123451234</td><td>Contacted</td>
                                  <td>
                                    <button class="btn btn-sm btn-info">View</button>
                                    <button class="btn btn-sm btn-warning">Edit</button>
                                    <button class="btn btn-sm btn-danger">Delete</button>
                                ...
                                <!-- Data 7 -->
                                <tr>
                                  <td>7</td><td>Priya R</td><td>9876549876</td><td>New</td>
                                  <td>
                                    <button class="btn btn-sm btn-info">View</button>
                                    <button class="btn btn-sm btn-warning">Edit</button>
                                    <button class="btn btn-sm btn-danger">Delete</button>
                                ...
                                <!-- Data 8 -->
                                <tr>
                                  <td>8</td><td>Vijay K</td><td>9000090000</td><td>Interested</td>
                                  <td>
                                    <button class="btn btn-sm btn-info">View</button>
                                    <button class="btn btn-sm btn-warning">Edit</button>
                                    <button class="btn btn-sm btn-danger">Delete</button>
                                ...
                                <!-- Data 9 -->
                                <tr>
                                  <td>9</td><td>Lavanya S</td><td>9888888888</td><td>Contacted</td>
                                  <td>
                                    <button class="btn btn-sm btn-info">View</button>
                                    <button class="btn btn-sm btn-warning">Edit</button>
                                    <button class="btn btn-sm btn-danger">Delete</button>
                                ...
                                <!-- Data 10 -->
                                <tr>
                                  <td>10</td><td>Divya M</td><td>9870012345</td><td>Interested</td>
                                  <td>
                                    <button class="btn btn-sm btn-info">View</button>
                                    <button class="btn btn-sm btn-warning">Edit</button>
                                    <button class="btn btn-sm btn-danger">Delete</button>
            ...
            <!--Enquiry Details end -->
                          ...
                          <form>
                            <div class="row g-3">
                              <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="enquiryName" placeholder="Enter name">
                              </div>
                              <div class="col-md-6">
                                <label for="enquiryEmail" class="form-label">Email</label>
                                <input type="email" class="form-control" id="enquiryEmail" placeholder="Enter email">
                              </div>
                              <div class="col-md-6">
                                <label for="enquiryMobile" class="form-label">Mobile</label>
                                <input type="text" class="form-control" id="enquiryMobile" placeholder="Enter mobile number">
                              </div>
                              <div class="col-md-6">
                                <label for="enquiryCompany" class="form-label">Company Name</label>
                                <input type="text" class="form-control" id="enquiryCompany" placeholder="Enter company name">
                              </div>
                              <div class="col-12">
                                <label for="enquiryProject" class="form-label">Project Requirement</label>
                                <textarea class="form-control" id="enquiryProject" rows="3" placeholder="Describe the project"></textarea>
                              </div>
                              <div class="col-md-6">
                                <label for="enquiryStatus" class="form-label">Status</label>
                                <select class="form-select" id="enquiryStatus">
              ...
              <div class="modal fade" id="viewEnquiryModal" tabindex="-1" aria-labelledby="viewEnquiryLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    ...
                    <!-- Header -->
                    <div class="modal-header">
                      <h5 class="modal-title" id="viewEnquiryLabel">Enquiry Details</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                        ...
                        <table class="table table-bordered table-sm align-middle">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>13-09-2025 10:15 AM</td>
                            </tr>
                            <tr>
                              <td>2</td>
                              <td>Contacted</td>
                              <td>13-09-2025 11:00 AM</td>
                            </tr>
                            <tr>
                              <td>3</td>
                              <td>Interested</td>
                              <td>13-09-2025 01:30 PM</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
              ...
              <!-- View Enquiry Modal end -->
                    ...
                    <!-- Edit Enquiry Modal start  -->
                  <div class="modal fade" id="editEnquiry1" tabindex="-1" aria-labelledby="editEnquiryLabel1" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="editEnquiryLabel1">Edit Enquiry</h5>
                          ...
                          <form>
                            <div class="row g-3">
                              <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" value="Arun Kumar">
                              </div>
                              <div class="col-md-6">
                                <label class="form-label">Email</label>
                                <input type="email" class="form-control" value="arun@example.com">
                              </div>
                              <div class="col-md-6">
                              ...
                              <div class="col-12">
                                ...
                                <textarea class="form-control" rows="3">Website Development</textarea>
                              </div>
                              <div class="col-md-6">
